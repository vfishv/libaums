...
public class UsbDocumentProvider extends DocumentsProvider {
    ...
    private static final String DOCUMENTS_AUTHORITY = "me.jahnen.libaums.storageprovider.documents";

    /**
     * Action string to request the permission to communicate with an UsbDevice.
     */
    private static final String ACTION_USB_PERMISSION = "me.jahnen.libaums.storageprovider.USB_PERMISSION";
